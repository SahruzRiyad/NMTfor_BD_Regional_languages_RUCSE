...
train_source_texts = []
train_target_texts = []
filePath = open("/home/riad/Desktop/NMT_thesis/chakma_model/train_bangla_data_2.txt","r")
for lines in filePath:
    line = lines.strip()
    train_source_texts.append(line)

filePath2 = open("/home/riad/Desktop/NMT_thesis/chakma_model/train_chakma_data_2.txt","r")
...
nmt_model.load_weights("/home/riad/Desktop/NMT_thesis/chakma_model/bn_to_chk.h5")
